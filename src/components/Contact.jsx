  ...
  return (
    ...
    >
      <motion.div
        ...
        className='flex-[0.75] p-8 rounded-2xl  bg-[#1435a3] '
      >
         {/* bg-black-100 */}
        ...
        >
          <label className='flex flex-col'>
            ...
            <input
              ...
              className='bg-tertiary py-4 px-6 placeholder:text-primary text-primary rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
